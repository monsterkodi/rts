...
Materials = 
    ...
    stone: [   
                ...
                new THREE.MeshStandardMaterial color:0x008822, dithering:true # green
                new THREE.MeshStandardMaterial color:0x222288, dithering:true # blue
                new THREE.MeshStandardMaterial color:0xff8822, dithering:true # yellow
    ...
    bot: [   
                ...
                new THREE.MeshStandardMaterial color:0x008822, dithering:false # green
                new THREE.MeshStandardMaterial color:0x222288, dithering:false # blue
                new THREE.MeshStandardMaterial color:0xff8822, dithering:false # yellow
